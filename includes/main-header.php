...
<div >
	<a  href="index.php">
		...
		<h3>Twenty-<span style="font-weight:1;">one </span>stores&trade;</h3>
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">K<?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>K<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
