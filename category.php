...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/chabzycollage.jpg" alt="" class="img-responsive">
			</div>
...
<!--chabzy color category-->
					<?php 
                $sql = mysqli_query($con, "SELECT categoryName FROM category WHERE id='$cid'");
                while ($row = mysqli_fetch_array($sql)) {
                    echo '<span style="color: white; font-weight: bold;font-size: 70px;">' . $row['categoryName'] . '</span>';
                }
                ?>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<button class="btn btn-info" type="button">Add to cart</button></a>
								<?php } else {?>
