...
if (isset($_POST['pay'])) {
    if (strlen($_SESSION['login']) == 0) {
	    ...
	    mysqli_query($con,"insert into orders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')");
        // Process the payment
        require 'makepayments/pay.php';
        pay($_POST['email'], $_POST['amount']);
	} 
}
}
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "K".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "K"." ".$row['shippingCharge']; ?>.00</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price">K<?php echo ($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00</span></td>
				</tr>
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Grand Total <span class="inner-left-md">K<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
	...
	<h3 style="font-weight:bold; color:blue;">Flutterwave</h3>
	
	<img src="airtel-logo.png"style="height: 30px;margin-left:5px;" alt="Airtel" >
	<img src="mtn-logo.png"style="height: 30px;margin-left:5px;" alt="Airtel" >
	<img src="mastercard-logo.png"style="height: 35px;margin-left:3px;" alt="Airtel" >

	<p>Airtel money, MTN money, Mastercard.</p>
	<form action="pay.php" method="POST">
		<div class="mb-3">
			<label for="email" class="form-label">Email</label>
			<input type="email" class="form-control" name="email" value="<?php echo $_SESSION['login'] ?>" readonly>
		</div>

		<div class="mb-3">
			<label for="amount" class="form-label">Amount</label>
			<input type="number" class="form-control" name="amount" value="<?php echo $_SESSION['tp'] ?>" required readonly>
		</div>

		<input type="submit" name="pay" class="btn btn-primary" style="margin-top:10px; " value="Pay">
	</form>
	<!-- End of Demo Payment Form -->
