...
if(isset($_POST['update'])) {
    ...
    if($query) {
        ...
        echo "<script>alert('Error updating info');</script>";
    }
}
...
if(isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "SELECT password FROM users WHERE password='$cpass' AND id='".$_SESSION['id']."'");
    $num = mysqli_fetch_array($sql);
    if($num) {
        $con->query("UPDATE users SET password='$newpass', updationDate='$currentTime' WHERE id='".$_SESSION['id']."'");
