...
<html lang="en">
    ...
    .register-container {
        ...
        background-image:url("EcomClip.jpg"); /* Optional: adds a light background */
    }
...
<div class="form-group">
	  	...
	  	<button type="submit" class="Bluebutton" name="change">Change</button>
		<div class="radio outer-xs">
		  	<a href="user_registration.php" class="forgot-password pull-right">Create an account</a>
		</div>
	</form>	
